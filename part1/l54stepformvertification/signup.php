		   ...
		   <form id="form" action="./registerfunction.php" method="POST" enctype="multipart/form-data" >
			   ...
			   <div class="page">
					...
					<input type="password" name="password" id="password" class="form-control" placeholder="Enter Passcode"  />
			   		<div>
						<input type="radio" name="newsletter" id="agree" class="form-check-input" value="0" checked /><label for="agree" class="form-check-label">I agree to get news letter</label>
						<br/>
						<input type="radio" name="newsletter" id="noagree" class="form-check-input" value="1" /><label for="noagree" class="form-check-label">I do not agree to get news letter</label>
					</div>
				</div>
