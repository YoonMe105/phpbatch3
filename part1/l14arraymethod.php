...
echo array_combine($name,$age)['aung aung'];

echo "<hr/>";

// array_count_values() Function
// array_count_vales(array)
...
$phones = ["mpt"=>"ftth","ooredoo"=>"broadban","als"=>"wifi"];
...
echo "<pre>".print_r($numbers,"true")."</pre>"; //0 to 100
...
$cars = ["volvo","bmw","toyato","mazada","suzuki"];
sort($cars);
...
// echo "<pre>".print_r(array_splice($colors,2,-1),"true")."</pre>"; //blue to yellow
...
array_splice($males,2,3,$females); 
...
echo "<pre>".print_r($colors,"true")."</pre>"; //black black black black black 
